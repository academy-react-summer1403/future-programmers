...
const StepOne = () => {
  return (
    <div className='dark:bg-gray-600  h-screen flex justify-center'>
      <div className='flex justify-around border-black-500 h-[580px] dark:bg-gray-600 dark:text-white hover:text-black-1000 w-screen m-auto '>
...
<h3 className='mt-7 font-bold text-lg text-[#555555] '> ورود با موبایل</h3>
<div className='flex'>
...
<div className="flex">
<h2 className="text-[#8D8D8D] text-xs mr-2"> ورود با ایمیل </h2>
