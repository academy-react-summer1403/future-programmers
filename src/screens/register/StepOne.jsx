  ...
  return (
    <div className=" dark:bg-[#152a38]  dark:text-[#ffff]  h-screen flex justify-center bg-[#F3F4F6] ">
      <div className="flex justify-around  dark:bg-[#678cb1]  rounded-lg h-[580px]  bg-white  shadow-lg  w-5/6 m-auto ">
        <div className=" h-[580px] w-[1138px] dark:bg-[#678cb1]  dark:text-[#d1d4c9] pt[20px] bg-white rounded-lg flex justify-between">
          <div className="dark:text-[#fff] h-[90%] w-96 rounded-xl mr-[30px]  ">
            ...
            <div className="h-[10%] mt-8 w-[90%]  flex">
              ...
              <h3 className="mr-12 font-bold text-xl dark:text-[#ffff]">
                {" "}
                آکادمی سپهر{" "}
              </h3>
            </div>
            ...
            {/* <div className=" bg-cyan-400 mt-2 text-lg"> */}
              <h3 className="mt-7 font-bold mr-7 text-lg text-[#555555] dark:text-[#ffff]">
                {" "}
                ثبت نام با موبایل
              </h3>
            {/* </div> */}
...
"
          ...
          <div className="hidden md:block h-[100%] w-[500px] max-md:w-[250px]">
            <img
              className="w-[100%] h-[100%] mr-12 rounded-lg dark:bg-[#001F3F] "
              src="./Image.png"
              alt=""
            />
          </div>
