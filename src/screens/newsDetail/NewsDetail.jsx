...
function NewsDetail() {
  ...
  return (
    <div className='bg-[#e6e5e5] font-[sans] dark:bg-gray-200'>
        ...
        <div className='w-[88%] mx-auto mt-[70px] pb-[30px] max-lg:mt-[50px] max-md:pb-[10px] max-md:mt-[40px] max-sm:mt-[25px]'>
            ...
            <div className='w-[92%] h-[400px] relative rounded-[15px] mr-[8%] mt-[15px] bg-white dark:bg-slate-600 max-lg:h-[380px] max-md:h-[250px] max-sm:h-[200px] max-sm:mt-[5px]'>
                ...
                <p className='w-[64%] h-[320px] overflow-hidden absolute right-[340px] top-[25px] text-[17px] dark:text-white max-lg:right-[305px] max-lg:w-[58%] max-md:right-[229px] max-sm:right-[185px] max-sm:h-[150px] max-sm:text-[13px]'> sdlkjlw sd;lsfew;l sdlfkjew;f</p>
            </div>
            <div className='w-[17%] relative text-[13px] py-5 right-[79%] rounded-b-[20px] text-center bg-[#9F9F9F] max-lg:text-[11px] max-lg:w-[19%] max-lg:right-[76%] max-lg:py-4 max-md:text-[10px] max-md:py-3 max-md:w-[24%] max-md:right-[71%] max-sm:text-[9px] max-sm:w-[25%] max-sm:right-[69%]'> نوشته شده توسط آرین کامیاب</div>
