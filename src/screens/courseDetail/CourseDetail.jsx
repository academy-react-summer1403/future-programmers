  ...
  return (
    <div className='bg-[#e6e5e5] font-[sans] dark:bg-slate-700 overflow-hidden'>
      ...
      <div className='w-[88%] mx-auto flex'>
        <div className=' relative h-[380px] w-[100%] sm:max-md:h-[250px] md:max-lg:h-[300px] mt-4 rounded-[30px] bg-[url(public/p.01.png)] bg-no-repeat [background-size:100%_100%]'>
            <div className="h-[100%] w-[100%] bg-black opacity-[0.98] rounded-[30px] absolute">
              <h1 className="text-stone-50  text-[24px] sm:max-md:text-[10px] sm:max-md:right-[30px]   font-black absolute top-[40px] right-[65px]">در لاراول Restful API آموزش کاربردی</h1>
              <p className=' text-gray-400 w-[420px] absolute top-[85px] right-[65px] sm:max-md:right-[30px] sm:max-md:w-[205px] sm:max-md:top-[56px] sm:max-md:text-[8px] '> در اینجا یاد می گیرید.ر اینجا یاد می گیرید.ر اینجا یاد می گیرید ر اینجا یاد می گیرید.گیرید.ر اینجا یاد می گیرید.ر ا</p>
              <img src='public/p.01.png' className='w-[450px] h-[310px] shadow-[8px_-13px_35px_-18px_gray] rounded-[25px] absolute right-[770px] top-[30px]  sm:max-md:right-[334px] sm:max-md:w-[44%] sm:max-md:h-[76%] '></img>
              <h3 className=' text-gray-400 line-through absolute top-[220px] right-[625px] sm:max-md:text-[11px] sm:max-md:right-[240px] sm:max-md:top-[164px] '> تومان 500,000</h3>
              <h2 className=' text-white	text-[22px] font-bold	absolute top-[250px] right-[580px] sm:max-md:text-[13px] sm:max-md:top-[180px] sm:max-md:right-[221px]'>تومان 400,000</h2>
              <button type='Submit' className='bg-cyan-700 text-[white] py-3 px-4 rounded-[10px] absolute top-[242px] right-[70px] sm:max-md:top-[165px] sm:max-md:p-[7px] sm:max-md:text-[11px] sm:max-md:right-[24px]'>خرید نقدی دوره</button>
            </div>  
        </div>
      </div>
      ...
      <div className=' flex flex-wrap justify-between w-[88%] mx-auto mt-5 dark:bg-slate-700 pb-[30px] overflow-hidden'>
        ...
        <div className='w-[63%] h-[auto] pb-3 bg-white rounded-[20px] sm:max-md:w-[100%] dark:bg-slate-500'>
        ...
        <div className='flex flex-wrap w-[33%] gap-y-3 sm:max-md:w-[100%]'>

          <div className='w-[99%] h-[385px] sm:max-md:w-[100%] sm:max-md:mt-3 bg-white rounded-[20px]  dark:bg-slate-500'>
            <img className='w-[18%] h-[18%] mt-[20px] mr-[27px] rounded-[50%] sm:max-md:h-[70px] sm:max-md:w-[70px]' src='public/01.jpg'></img>
            ...
            <div className='align-center mt-[10px]'><a href='#' className='text-[12px] [background:url(public/external-link.svg)_no-repeat_93%_0%] pr-[30px] mr-[75px] sm:max-md:mr-[30%]'>مشاهده سایر آموزش های این استاد</a></div>
          </div>

          <div className=' w-[99%] h-[385px] bg-white rounded-[20px] dark:bg-slate-500 sm:max-md:top-[992px] sm:max-md:w-[100%] sm:max-md:mt-3'>
      ...
      <div className='w-[64%] h-[400px] bg-white mt-[30px] sm:max-md:mt-0 rounded-[20px] sm:max-md:w-[100%] dark:bg-slate-500'>
