      ...
      <div className='w-[88%] mx-auto flex'>
        <div className=' relative h-[380px] w-[100%] sm:max-md:h-[250px] md:max-lg:h-[300px] mt-4 rounded-[30px] bg-[url(public/p.01.png)] bg-no-repeat [background-size:100%_100%]'>
            <div className="h-[100%] w-[100%] bg-black opacity-[0.98] rounded-[30px]">
              <h1 className="text-stone-50  text-[24px] sm:max-md:text-[10px] sm:max-md:right-[30px] md:max-lg:text-[13px] md:max-lg:right-[38px] font-black absolute top-[40px] right-[65px]">در لاراول Restful API آموزش کاربردی</h1>
              <p className=' text-gray-400 w-[420px] absolute top-[85px] right-[65px] sm:max-md:right-[30px] sm:max-md:w-[205px] sm:max-md:top-[56px] sm:max-md:text-[8px] md:max-lg:top-[60px] md:max-lg:text-[10px] md:max-lg:right-[38px] md:max-lg:w-[251px]'> در اینجا یاد می گیرید.ر اینجا یاد می گیرید.ر اینجا یاد می گیرید ر اینجا یاد می گیرید.گیرید.ر اینجا یاد می گیرید.ر ا</p>
              <img src='public/p.01.png' className='w-[450px] h-[310px] shadow-[8px_-13px_35px_-18px_gray] rounded-[25px] absolute right-[770px] top-[30px]  sm:max-md:right-[334px] sm:max-md:w-[44%] sm:max-md:h-[76%] md:max-lg:right-[406px] md:max-lg:h-[76%] md:max-lg:w-[43%] '></img>
              <h3 className=' text-gray-400 line-through absolute top-[220px] right-[625px] sm:max-md:text-[11px] sm:max-md:right-[240px] sm:max-md:top-[164px] md:max-lg:text-[12px] md:max-lg:top-[175px] md:max-lg:right-[295px]'> تومان 500,000</h3>
              <h2 className=' text-white	text-[22px] font-bold	absolute top-[250px] right-[580px] sm:max-md:text-[13px] sm:max-md:top-[180px] sm:max-md:right-[221px] md:max-lg:text-[14px] md:max-lg:top-[200px] md:max-lg:right-[273px]'>تومان 400,000</h2>
              <button type='Submit' className='bg-cyan-700 text-[white] py-3 px-4 rounded-[10px] absolute top-[242px] right-[70px] sm:max-md:top-[165px] sm:max-md:p-[7px] sm:max-md:text-[11px] sm:max-md:right-[24px] md:max-lg:text-[12px] md:max-lg:right-[38px] md:max-lg:top-[190px]'>خرید نقدی دوره</button>
            </div>  
        </div>
      </div>
