...
const CourseCard = ({image,topic, explain, teacher, time, price}) => {
  return (
    <div className=" relative w-[31%] max-sm:w-[95%] max-md:w-[31%] md:max-lg:w-[30%] h-[360px] max-md:h-[300px] md:max-lg:h-[220px] bg-white rounded-[20px] dark:dark:bg-[#29435c] dark:text-[#d1d4c9]">
        ...
        <p className="w-[97%] h-10 max-sm:relative max-sm:bottom-[7px] max-sm:text-[11px] max-md:text-[10px] max-md:h-14 md:max-lg:h-16 mr-1 md:max-lg:mx-auto text-[12px] md:max-lg:text-[8px] md:max-lg:relative md:max-lg:bottom-3 bottom-0 overflow-hidden dark:text-[#d1d4c9]">{explain}</p>
        ...
        <span className="relative top-24 max-md:top-[30px] max-md:text-[11px] md:max-lg:top-2 bg-slate-400 rounded-2xl text-[14px] md:max-lg:text-[10px] p-1 pl-5 md:max-lg:pl-4 bg-[url(public/timer.png)] bg-no-repeat bg-left [background-size:18px] md:max-lg:[background-size:14px] dark:dark:bg-[#556e53] dark:text-[#d1d4c9]">{time}</span>
