...
const CourseCard = ({image,topic, explain, teacher, time, price}) => {
  return (
    <div className=" relative w-[278px] max-sm:w-[95%] max-md:w-[31%] md:max-lg:w-[30%] h-[360px] max-md:h-[300px] md:max-lg:h-[220px] bg-white rounded-[20px] dark:dark:bg-[#29435c] dark:text-[#d1d4c9]">
        ...
        <p className="w-[97%] h-10 max-sm:relative max-sm:bottom-[7px] max-sm:text-[11px] max-md:text-[10px] max-md:h-14 md:max-lg:h-16 mr-1 md:max-lg:mx-auto text-[13px] md:max-lg:text-[8px] md:max-lg:relative md:max-lg:bottom-3 bottom-0 overflow-hidden dark:text-[#d1d4c9]">{explain}</p>
