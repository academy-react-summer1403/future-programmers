...
const CourseCard = ({image,topic, explain, teacher, time, price}) => {
  return (
    <div className="w-[278px] h-[360px] bg-white rounded-[20px]">
        ...
        <span className="relative top-16 mr-1 bg-slate-400 rounded-2xl text-[15px] p-1 pl-5 bg-[url(public/timer.png)] bg-no-repeat bg-left [background-size:20px]">{time}</span>
