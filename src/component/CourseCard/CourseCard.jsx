...
const CourseCard = ({image,topic, explain, teacher, time, price}) => {
  return (
    <div className=" relative w-[278px] md:max-lg:w-[30%] h-[360px] md:max-lg:h-[220px] bg-white rounded-[20px] dark:bg-slate-600">
        ...
        <ul className="relative top-3 mr-1 md:max-lg:top-[-10px] text-[13px] md:max-lg:text-[10px] list-disc list-inside text-[#0004ff] dark:text-white"><li>{teacher}</li></ul>
        ...
        <span className="relative top-14 md:max-lg:top-2 right-[120px] md:max-lg:right-[36px] md:max-lg:text-[12px] text-[15px] text-red-700 dark:text-white" >{price}</span>
    </div>
  )
}
