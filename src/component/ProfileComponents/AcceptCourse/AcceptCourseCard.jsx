...
const AcceptCourseCard = ({
  ...
  return (
    ...
    >
      <h3 className=" text-lg font-bold text-ellipsis text-center w-[30%]">
        {" "}
        {courseTitle}
      </h3>

      <div className=" w-[30%]"> {fullName}</div>
      <div className=" w-[10%]"> {termName}</div>
      <div className=" w-[10%]"> {levelName}</div>
