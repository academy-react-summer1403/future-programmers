...
function FilterInTop({handleCategoryFilter, handleTypeCourseFilter}) {
  return (
    <div className="drawer drawer-end md:hidden  w-[10%]">
        ...
        <div className="drawer-side z-[999] max-md:w-[35%] max-sm:w-[268px]">
            ...
            <ul className="menu bg-base-200 text-base-content min-h-full p-4 dark:bg-[#29435c]">
                ...
                <ReponsiveFilters handleCategoryFilter={handleCategoryFilter} handleTypeCourseFilter={handleTypeCourseFilter} />
            </ul>
        </div>
    </div>
  )
