  ...
  return (
    <div className="drawer drawer-end md:hidden  w-[10%]">
        ...
        <div className="drawer-content w-[10%] ">
            {/* Page content here */}
            <label htmlFor="my-drawer-4" className="drawer-button btn btn-primary hover:bg-[white] border-0 bg-[white] bg-center w-[100%] h-[100%] bg-[url(public/filter.png)] bg-no-repeat [background-size:19px] dark:bg-[#556e53]"></label>
        </div>
