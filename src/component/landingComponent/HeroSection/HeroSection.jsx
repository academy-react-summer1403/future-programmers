      ...
      <div className="z-[999] pb-[30px] overflow-x-hidden  dark:text-[#d1d4c9]">
        <div className=" py-8 px-4 mx-auto flex flex-row justify-around">
          <div className="text-center md:text-right  w-full md:w-[40%] ">
            <h1 className="text-[40px] max-lg:text-[35px] max-sm:text-[25px] mx-auto font-bold mb-4 mt-12 max-sm:mt-5 max-sm:mb-0  text-[#436E8E] dark:text-[#d1d4c9] ">
              دنبال چی می گردی؟
            </h1>
            <p className="text-gray-500 dark:text-slate-50 mt-7 max-lg:mt-0 max-sm:mt-3">
            ...
            />
            {Open && <LandingModal setOpen={setOpen} />}
            <h3 className=" mt-[15px] max-lg:mt-[10px] font-semibold max-sm:font-normal text-[25px] max-lg:text-[21px]">
              آکادمی سپهر
            </h3>
            <p className="mt-3 text-[14px] max-lg:text-[11px] max-md:text-[12px] max-sm:text-[10px] text-gray-600 dark:text-[#d1d4c9] sm:w-[70%] md:w-full mx-auto">
              {" "}
              آکادمی آموزشی سپهر مکانی برای پیشرفت تو تا بتونی مهارت های مورد
              نیاز برای طراحی وب رو هر چه سریعتر و با بهترین روش یاد بگیری
            </p>
          </div>
          <div className="relative hidden md:block w-[405]">
            ...
            <img
              src="./Path 2.png"
              className="absolute top-20 w-[21%] right-[78%]"
            />
          </div>
        </div>
      </div>
