...
const LandingModal = ({ setOpen }) => {
  ...
  return (
    <div className="w-[50%] max-sm:w-[80%] max-h-[300px] overflow-y-scroll overflow-hidden rounded-[10px] pb-5 bg-white shadow absolute z-40 top-24 max-sm:top-[200px] max-md:top-[260px] max-lg:top-[270px] left-[300px] max-sm:left-[37px] max-md:left-[189px] max-lg:left-[500px]">
