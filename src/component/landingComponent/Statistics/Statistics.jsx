...
function Statistics() {
    ...
    return (
        <div className="flex justify-end max-sm:justify-center mx-auto px-4 sm:h-44 lg:h-96 bg-[url(public/Group.png)] max-sm:bg-none [background-size:49%_125%] max-lg:[background-size:35%_125%] [background-position-x:100%] bg-no-repeat">
            ...
            <div className="max-sm:w-[90%] max-lg:w-[70%] w-[65%] pl-14 max-md:pl-12 max-sm:pl-0  text-center content-center flex flex-wrap justify-between  max-sm:shadow-md">
                    <div className="flex flex-wrap justify-between max-sm:justify-between basis-full max-sm:text-[9px] max-md:text-[12px] max-lg:text-[13px] dark:bg-[#29435c] rounded-xl overflow-hidden">
